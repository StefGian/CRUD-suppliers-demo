 ...
 * @returns {{id: null, firstName: string, lastName: string, address: string, zipCode: string, city: string, companyName: string, irsOffice: string, vatNumber: string, country: string}}
 */
